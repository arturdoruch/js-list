...
export default class FilterFormController {
    ...
    constructor(formSelector, options) {
        ...
        this._queryParameterNames = JSON.parse(document.querySelector('input[name="list-query-parameter-names"]').value);
        this._resetSorting = document.querySelector('input[name="filter-form-reset-sorting['+this._form.getName()+']"]').value == 1;

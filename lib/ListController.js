...
export default class ListController {
    /**
     * @param {HTMLElement|jQuery|string} listContainer The HTMLElement or jQuery object, or CSS selector of the element holding the list items.
     ...
     */
    constructor(listContainer, filterForm, options) {
        if (!listContainer) {
    ...
    _getAndUpdateList(url) {
        ...
        ajax.send(url, this._options.gettingItemsMessage, this._options.gettingItemsLoader)
            .done(function(html) {
                ...
                } else if (self._filterForm) {
                    self._filterForm.setCurrentUrlQuery(url);
                }
